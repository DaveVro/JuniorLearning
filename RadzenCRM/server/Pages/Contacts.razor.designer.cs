...
namespace RadzenCrm.Pages
{
    public partial class ContactsComponent : ComponentBase
    {
        ...
        {
            var crmGetContactsResult = await Crm.GetContacts(new Query() { Filter = $@"i => i.Email.Contains(@0) || i.FirstName.Contains(@1) || i.LastName.Contains(@2) || i.Company.Contains(@3)", FilterParameters = new object[] { contactFilter, contactFilter, contactFilter, contactFilter } });
            getContactsResult = crmGetContactsResult;
        }
